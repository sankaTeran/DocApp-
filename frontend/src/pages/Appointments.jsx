    ...
    for (let i = 0; i < 7; i++) {
      ...
      if (today.getDate() === currentDate.getDate()) {
        ...
        if (currentHour < 10) {
          ...
          let nextSlotMinutes = currentMinute <= 30 ? 30 : 60;
          currentDate.setHours(currentHour + (nextSlotMinutes === 60 ? 1 : 0));
          currentDate.setMinutes(nextSlotMinutes === 60 ? 0 : 30);
        }
      } else {
        currentDate.setHours(10, 0, 0, 0); // Start future days at 10:00 AM
      }
